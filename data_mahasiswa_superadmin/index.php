                  ...
                  ?>
                      <tr>
                        ...
                        if ($kelamin == 'L') {
                          ...
                          data-nim="<?= $nim; ?>">
                            <img src="<?= ($img != null) ? $img : '../asset_adminlte/img/mhs-lk.jpg' ?>"  alt="foto mhs laki-laki" style="width:70px">
                          </button>
                          <?php
                        }else {
                          ?>
                          <button type="button" data-toggle="modal" data-target="#modal-foto" class="btn btn-default"
                          data-nim="<?= $nim; ?>">
                            <img src="<?= ($img != null) ? $img : '../asset_adminlte/img/mhs-perempuan.jpg' ?>" alt="foto mhs perempuan" style="width:70px">
                          </button>
                          <?php
                        }
                        ?>
                        ...
                        <td>
                          ...
                          <a href="edit.php?nim=<?= $nim; ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                          <a href="hapus.php?nim=<?= $nim; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah kamu yakin menghapus data ini?')"><i class="fas fa-trash"></i></a>
                        </td>
                      </tr>
                  <?php
                    }
      ...
      <div class="modal-content">
        ...
        <form action="proses_edit.php" method="post">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">Nim</label>
              <input type="number" class="form-control" id="nim" placeholder="Masukkan Nim" name="nim" readonly>
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Kontak</label>
              <input type="text" class="form-control" id="kontak" placeholder="Masukkan Kontak" name="kontak" required>
        ...
        <form action="proses_import.php" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="file" class="form-control" id="nama" placeholder="Masukkan Nama" name="file_mahasiswa" required>
            </div>
          </div>
          <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
